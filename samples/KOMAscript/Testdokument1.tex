%% NOTE THAT THIS REQUIRES PDFLATEX COMPILATION %%
%% Andy Clifton, 22 Jun 2019 %%
...
\usepackage[english,german]{babel} 		% deutsche Bibliography
...
Ein kleines B\"achlein namens \emph{Duden} fließt durch ihren Ort und versorgt sie mit den nötigen Regelialien.
%\end{document}
...
%\begin{table}[htbp]
%	\centering
%		\begin{tabularx}{300pt}{p{1cm} | p{1cm} p{1cm}}
%			\thead{11} & \thead{12} & \thead{13} \\ \hline
%			21 & 22 & 23 \\
%			31 & 32 & 33 \\
%		\end{tabularx}
...
%
%Es ist ein paradiesmatisches Land, in dem einem \index{gebratene} Satzteile in den Mund fliegen. Nicht einmal von der allmächtigen Interpunktion\footnote{Zeichensetzung im Satz} werden die Blindtexte beherrscht - ein geradezu unorthographisches Leben. Eines Tages aber beschloss eine \index{kleine!Zeile}kleine Zeile Blindtext, ihr Name war Lorem Ipsum, hinaus zu gehen in die weite Grammatik.
%
