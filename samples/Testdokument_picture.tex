...
\put(50,30){\circle*{1}}
\put(50,31){\makebox(0,0)[b]{$C_{(50,30)}$}}
\end{picture}
...
\minisec{Anzahl der Studenten}

\begin{barenv}
\setstretch{1.4}
\setxaxis{1}{4}{1}\setxname{Quartal}
\setyaxis{0}{40}{10}\setyname{Anzahl}
\bar{10}{1} \bar{30}{4}
\bar{15}{6} \bar{5}{7}
\end{barenv}
...
\begin{picture}(70,20)(0,0)
\thickline
\dottedline{2}(0,15)(70,15)
\dottedline[$\bullet$]{3}(0,10)(70,10)
\dottedline[$\diamond$]{4}(0,5)(0,5)
\dottedline[$\clubsuit$]{10}(0,0)(70,0)
\dottedline[$\heartsuit$]{10}(5,0)(65,0)
\end{picture}
